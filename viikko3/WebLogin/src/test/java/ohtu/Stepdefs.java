...
public class Stepdefs {
    ...
    public void shortUsernameAndValidPassword(String username, String password) {
        createUserWith(username, password);
    }

    @Then("user is not created and error \"username should have at least 3 characters\" is reported")
    public void newUserNotCreatedAndErrorMessageAboutUsernameCorrect() {
    ...
    public void validUsernameAndShortPasswordEntered(String username, String password) {
        createUserWith(username, password);
    }

    @Then("user is not created and error \"password should have at least 8 characters\" is reported")
    public void newUserNotCreatedAndErrorMessageAboutPasswordCorrect() {
    ...
    public void validUsernameAndPasswordWithUnmatchingConfirmationEntered(String username, String password, String confirmation) {
        createUserWith(username, password, confirmation);
    }

    @Then("user is not created and error \"password and password confirmation do not match\" is reported")
    public void newUserNotCreatedAndErrorMessageAboutUnmatchingPasswordAndConfirmationCorrect() {
        pageHasContent("password and password confirmation do not match");
    }

    @Given("user with username {string} with password {string} is successfully created")
    public void aNewUserIsCreated(String username, String password) {
        newUserIsSelected();
        createUserWith(username, password);
    }

    @When("the newly created username {string} and its password {string} are entered")
    public void newUsersCredentialsAreEntered(String username, String password) {
        logInWith(username, password);
    }
    
    @Given("user with username {string} and password {string} is tried to be created")
    public void tryingToCreateInvalidUser(String username, String password) {
        newUserIsSelected();
        createUserWith(username, password);
    }
    
    @When("the invalid username {string} and its password {string} are entered")
    public void newUserWithInvalidCredentialsLoggingIn(String username, String password) {
        logInWith(username, password);
    }
