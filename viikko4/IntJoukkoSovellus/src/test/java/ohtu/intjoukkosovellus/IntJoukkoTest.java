...
public class IntJoukkoTest {
    ...
    public void vainLisatytLuvutLoytyvat() {
        assertTrue(joukko.lukuLoytyyJoukosta(10));
        assertFalse(joukko.lukuLoytyyJoukosta(5));
        assertTrue(joukko.lukuLoytyyJoukosta(3));
    }

    @Test
    public void poistettuEiOleEnaaJoukossa() {
        joukko.poista(3);
        assertFalse(joukko.lukuLoytyyJoukosta(3));
    ...
    public void toimiiKasvatuksenJalkeen(){
        ...
        assertTrue(joukko.lukuLoytyyJoukosta(11));
        joukko.poista(11);
        assertFalse(joukko.lukuLoytyyJoukosta(11));
